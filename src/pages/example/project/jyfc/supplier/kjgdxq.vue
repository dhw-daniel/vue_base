        ...
        <div class="bcontainer line-space padding30lr padding30tb infoarea">
            ...
            <div class="prop">
                <ul>
                    ...
                    <li><span>工单状态</span>{{statusName[info.status]}}</li>
                    <li><span>工单费用</span><strong>{{info.amt}}</strong></li>
...
export default {
  ...
  methods: {
    ...
    getSupplierDemandWoInfo: function () {
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.getSupplierDemandWoInfo.path
      var obj = {id: this.id}
