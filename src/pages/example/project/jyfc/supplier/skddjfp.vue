...
export default {
  ...
  methods: {
    ...
    save: function () {
      ...
      this.saveSupplierSettleFp()
    },
    saveSupplierSettleFp: function () {
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.saveSupplierSettleFp.path
      var obj = {id: this.id, fplx: this.pv, kdlx: this.number1, kdsn: this.number2, jcsj: this.date, fpsn: this.code}
