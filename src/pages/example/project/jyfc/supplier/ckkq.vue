...
export default {
  ...
  methods: {
    getSupplierWrtAttenceInfo: function () {
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.getSupplierWrtAttenceInfo.path
      var obj = {id: this.id}
  ...
  mounted: function () {
    ...
    if (spid) {
      this.getSupplierWrtAttenceInfo()
    }
  }
}
</script>
