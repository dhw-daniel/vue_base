            ...
            <mt-tab-container v-model="selected">
                <mt-tab-container-item id="1">
                    <div class="p1">
                        ...
                        <mt-cell title="人月价格" v-model="info.amt"></mt-cell>
                    </div>
...
export default {
  ...
  methods: {
    getSupplierEpibolyStaffInfo: function () {
      this.loading = true
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.getSupplierEpibolyStaffInfo.path
  ...
  mounted: function () {
    this.getSupplierEpibolyStaffInfo()
  }
}
</script>
<style>
