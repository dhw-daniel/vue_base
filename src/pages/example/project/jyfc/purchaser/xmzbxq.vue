...
export default {
  ...
  methods: {
    ...
    getPurchaserDemandWholeInfo: function () {
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.getPurchaserDemandWholeInfo.path
      var obj = {id: this.id}
  ...
  mounted: function () {
    ...
    this.getPurchaserDemandWholeInfo()
  }
}
</script>
