    ...
    <div>
        ...
        <div>
            <div class="bcontainer2 line-space">
                <div class="halfdiv" @click="openPicker"><span ref="d1span">确认状态</span><i class="icon iconfont">&#xe609;</i></div>
                <div class="searchdiv"><mt-search v-model="value" cancel-text="取消" placeholder="员工姓名"> </mt-search></div>
            </div>
        </div>
