...
export default {
  ...
  methods: {
    getPurchaserDemandQuarterInfo: function () {
      var apiUrl = this.GLOBAL.requestHost + this.GLOBAL.requestList.getPurchaserDemandQuarterInfo.path
      var obj = {id: this.id}
  ...
  mounted: function () {
    ...
    this.getPurchaserDemandQuarterInfo()
  }
}
</script>
